...
function fingerprintRnd() {
    return {
        ...
        'components': {
            'fonts': {
                'value': ['sans-serif-thin', 'serif', 'monospace', 'cursive'][Math.floor(Math.random() * 4)],
            ...
            'languages': {
                'value': [['en-US', 'es-ES', 'fr-FR'][Math.floor(Math.random() * 3)]],
                'duration': getRandomNumber(0, 100),
            },
            'colorDepth': {
            ...
            'timezone': {
                'value': ['Africa/Addis_Ababa', 'America/New_York', 'Asia/Tokyo'][Math.floor(Math.random() * 3)],
                'duration': getRandomNumber(0, 100),
            },
            ...
            'platform': {
                'value': ['Linux aarch64', 'Windows x64', 'MacIntel'][Math.floor(Math.random() * 3)],
                'duration': getRandomNumber(0, 100),
            },
            'plugins': {'value': [], 'duration': getRandomNumber(0, 100)},
            'touchSupport': {
                'value': {
                    'maxTouchPoints': [1, 2, 5][Math.floor(Math.random() * 3)],
            ...
            'webGlBasics': {
                'value': {
                    'version': ['WebGL 1.0', 'WebGL 2.0'][Math.floor(Math.random() * 2)],
                    'vendor': ['WebKit', 'Mozilla'][Math.floor(Math.random() * 2)],
                    'vendorUnmasked': ['Qualcomm', 'NVIDIA'][Math.floor(Math.random() * 2)],
                    'renderer': ['WebKit WebGL', 'NVIDIA WebGL'][Math.floor(Math.random() * 2)],
                    'rendererUnmasked': ['Adreno (TM) 610', 'GeForce GTX 1060'][Math.floor(Math.random() * 2)],
                    'shadingLanguageVersion': ['WebGL GLSL ES 1.0', 'WebGL GLSL ES 3.0'][Math.floor(Math.random() * 2)],
                }, 'duration': getRandomNumber(0, 100),
            },
